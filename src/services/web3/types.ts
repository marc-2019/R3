...
export enum NetworkType {
  ...
  // src/services/web3/Web3Service.ts
  import Web3 from 'web3';
  import { WebsocketProvider } from 'web3-core';
  import { NetworkConfig, NetworkType, ConnectionStatus, ConnectionEventCallback, NETWORK_CONFIGS } from './types';
  ...
  // src/services/web3/index.ts
  export { Web3Service } from './Web3Service';
  export { NetworkType, type NetworkConfig, type ConnectionStatus } from './types';
  export { NETWORK_CONFIGS } from './constants';